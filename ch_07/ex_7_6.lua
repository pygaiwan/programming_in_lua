...
function create_dir(dirname)
    ...
    if success then
        ...
        error(string.format('Something went wrong with the create_dir function. Error code %d',
            signal))
    end
end
...
function remove_dir(dirname)
    ...
    if success then
        ...
        error(string.format('Something went wrong with the remove_dir§ function. Error code %d',
            signal))
    end
end
...
function list_files(dirname)
    ...
    if res then
        ...
        error("Something went wrong with the list_files function.")
    end
end
