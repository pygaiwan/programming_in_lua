...
--- Recursive function to generate all combiantions
---@param arr table: The input array
---@param n integer: Number of elements in the array
---@param m integer: Number of elements in the combiantion
---@param index integer: Current index in the array
---@param data table: Temp table to store the combiantions
